...
created: 2026-05-04
updated: 2026-05-04
tags: [visual-testing, playwright, puppeteer, e2e, screenshot, laravel, Rating]
related:
...
I test Playwright del modulo Rating appartengono a:

```
laravel/Modules/Rating/tests/Playwright/
```
...
```javascript
// laravel/Modules/Rating/tests/Playwright/visual-regression.spec.js
import { test, expect } from '@playwright/test';

test('Rating UI renders correctly', async ({ page }) => {
    await page.goto('/it/...');
    await page.waitForLoadState('networkidle');
    await expect(page).toHaveScreenshot('Rating-initial.png', {
